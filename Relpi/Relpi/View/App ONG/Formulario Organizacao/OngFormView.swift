            ...
            ScrollView {
                VStack {
                    ...
                    VStack(spacing: 30) {
                        ...
                        if (viewModel.modo == .perfil || pageIndex == 3) && (viewModel.ong != viewModel.ongInicial || viewModel.selectedImage != nil && viewModel.selectedImage?.pngData() != viewModel.downloadedImage?.pngData()){
                        Button("Salvar") {
                            viewModel.salvar()
